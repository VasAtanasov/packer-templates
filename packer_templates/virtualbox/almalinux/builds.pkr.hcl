// =============================================================================
// AlmaLinux VirtualBox Build Configuration
// =============================================================================
// Build orchestration and provisioning for AlmaLinux on VirtualBox
// =============================================================================
...
build {
  ...
  provisioner "shell" {
    inline = [
      ...
      # "bash /usr/local/lib/k8s/scripts/rhel/systemd.sh",
      # "bash /usr/local/lib/k8s/scripts/rhel/sudoers.sh",
      # "bash /usr/local/lib/k8s/scripts/rhel/networking.sh",
    ]
    environment_vars = [
      "LIB_DIR=/usr/local/lib/k8s",
      "LIB_CORE_SH=${local.lib_core_sh}",
  ...
  provisioner "shell" {
    inline = [
      "bash /usr/local/lib/k8s/scripts/rhel/cleanup.sh",
    ]
    environment_vars = [
      "LIB_DIR=/usr/local/lib/k8s",
      "LIB_CORE_SH=${local.lib_core_sh}",
